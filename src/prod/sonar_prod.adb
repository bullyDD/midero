...
package body Sonar_Prod is
   ...
   begin
      ...
      Enable_Clock (Sensor.Input_Pin);
      Sensor.Input_Pin.Configure_IO ((Mode_Analog, Resistors => Floating));

      Enable_Clock (Sensor.Converter.all);
      Configure_Unit (Sensor.Converter.all,
                      Resolution => Sensor_ADC_Resolution,
                      Alignment => Right_Aligned);
      
      Configure_Regular_Conversions
        (This        => Sensor.Converter.all,
         Continuous  => False,
         Trigger     => Software_Triggered,
         Enable_EOC  => True,
         Conversions => Regular_Conversion (Sensor.Input_Channel));
      Sensor.Enable;
   end Initialize;
   ---------------------
   -- Get_Raw_Reading --
